...
<script>		
	...
	function RequestData() {
		$.ajax({
			...
			var AVG_LENGTH = 3; // 2 minutes @ 6x a minute
	...
	$(document).ready(function () {
		$('#magContainer').highcharts('StockChart',{
			...
			subtitle:
				{
					text: 'Graph auto-refreshes every 2 mins. <br>Click and drag or use controls to zoom in on data and to reset view.'
				},
			xAxis:{
			categories: ["PLEASE WAIT... Loading Data..."]
			},
			yAxis: { 
				title: {
...
Highcharts.theme = {
   ...
   xAxis: {
      gridLineColor: '#405040',
	  gridLineWidth: 1, // or 1
      labels: {
         style: {
            color: '#E0E0E3'
         }
